<x-dashboard-layout>
    ...
    <form id="form" class="container-fluid" action="{{ route('product.lists.store') }}" method="POST"
        ...
        <div class="row">
                ...
                <div class="input-group">
                    ...
                    <select name="product_category_id" id="product-category"
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" @selected($category->id == old('product_category_id'))>{{ $category->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-3 col-md-8">
                ...
                <input type="text"
                    ...
                    name="name" placeholder="Masukkan nama barang" value="{{ old('name') }}" required>
        ...
        <div class="row">
            <div class="mb-3 col-md">
                ...
                <input type="hidden" name="purchase_price" value="{{ old('purchase_price') }}">
                <input type="text"
            ...
            <div class="mb-3 col-md">
                ...
                <input type="hidden" name="selling_price" value="{{ old('selling_price') }}">
                <input type="text"
            ...
            <div class="mb-3 col-md">
                ...
                <input type="number"
                    ...
                    id="stock" name="stock" placeholder="Masukkan stok barang" value="{{ old('stock') }}"
                    required>
            ...
            <div class="mb-3">
                ...
                <div class="dropzone rounded-1 text-center @error('image') is-invalid @enderror" id="imageDropzone">
                    <div class="dz-message">
                        <img src="{{ asset('assets/images/image.png') }}" alt="Upload Icon">
                        <p class="mt-2">upload gambar disini</p>
                    </div>
                </div>
